...
_blackListedArea0 = nearestObjects [spawnCenter, ["House", "Building"], 2000];
_blackListedArea1 = nearestObjects [getMarkerPos "plane_spawn", ["House", "Building"], 1000];
