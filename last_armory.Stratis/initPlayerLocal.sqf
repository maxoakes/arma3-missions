...
[
	"Arsenal Sign",
	"The large sign in the spawn features inventory management and fast travel options. See what is available."
], taskNull, "", false];

_player createDiaryRecord ["Diary",
[
	"Sector Control",
	"The map board in the spawn allows for the creation of a classic Arma 'sector control' objective that anyone can take part in. When one is created, it will be up to players to make their way to the sector and kill any enemies. Once the initial enemy squad is killed, players will need to defend the sector against some number of waves of enemies. The number of enemy units increases each wave. If the sector is re-taken by the enemy, the mission is failed and sector will be deleted. Only one sector can be active at a time."
], taskNull, "", false];
...
[
	"Spawn",
	"The spawn area allows access to most features of the armory. There, vehicle spawning is possible via several objects placed radially. There are other objects dedicated to fast travel, objective creation, inventory management and more. All objects use 'actions' which can be viewed by scrolling while looking at an object."
], taskNull, "", false];
