...
private _primaryMags = [primaryWeapon _newUnit, !_isDayTime] call SCO_fnc_getRoundsForWeapon;
private _handgunMags = [handgunWeapon _newUnit, !_isDayTime] call SCO_fnc_getRoundsForWeapon;
